    ...
    <div class="container pt-3">
        <div class="col-lg ">
            <div class="bg-light">
                ...
                <h2 class="text-center text-dark p-3">Update Form</h2>
                ...
                <form class="form-horizontal" action="{{ route('student.UpdateInfo') }}" method="POST"  >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" id="university" name=university>
                                <option value="{{ $student->university }}">Select Options</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" id="department" name=department>
                                <option value="{{ $student->department }}">Select Options</option>
                    ...
                    <div class = "form-group">
                        ...
                        <div class="col-sm-10">
                            <button class="registerbtn btn btn-primary" type="submit">Update</button>
